    ...
    <%--<div class="col-md-12">--%>
      <%--<div class="panel panel-primary">--%>
        ...
        <%--<div class="panel-body">--%>
          ...
          <%--</div>--%>
          <%--<div class="col-xs-3 col-md-2">--%>
          <%--&lt;%&ndash;<form role="form" class="form-inline">&ndash;%&gt;--%>
          <%--&lt;%&ndash;<div class="form-group">&ndash;%&gt;--%>

          <%--&lt;%&ndash;<label for="tableName">&ndash;%&gt;--%>
          <%--&lt;%&ndash;数据&ndash;%&gt;--%>
          <%--&lt;%&ndash;</label>&ndash;%&gt;--%>
          <%--&lt;%&ndash;<select id="tableName" class="form-control">&ndash;%&gt;--%>
          <%--&lt;%&ndash;<option value="bd_meetup">组织</option>&ndash;%&gt;--%>
          <%--&lt;%&ndash;<option value="bd_member" selected>成员</option>&ndash;%&gt;--%>
          <%--&lt;%&ndash;</select>&ndash;%&gt;--%>
          <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
          <%--&lt;%&ndash;<div class="form-group">&ndash;%&gt;--%>

          <%--&lt;%&ndash;<label for="year">&ndash;%&gt;--%>
          <%--&lt;%&ndash;年份&ndash;%&gt;--%>
          <%--&lt;%&ndash;</label>&ndash;%&gt;--%>
          <%--&lt;%&ndash;<select id="year" class="form-control">&ndash;%&gt;--%>
          <%--&lt;%&ndash;<option value="0" selected>全选</option>&ndash;%&gt;--%>
          ...
          <%--&lt;%&ndash;<button id="search" type="button" class="btn btn-success">&ndash;%&gt;--%>
          <%--&lt;%&ndash;搜索&ndash;%&gt;--%>
          <%--&lt;%&ndash;</button>&ndash;%&gt;--%>
        ...
        <%--&lt;%&ndash;<div id="chart" class="col-md-12" style="height:85%;"></div>&ndash;%&gt;--%>
        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
      <%--</div>--%>
