...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/app/meetup/audit.js"></script>
...
<form id="form" name="form" class="form-horizontal" method="post"
    ...
    <input type="hidden" class="form-control"
           value="${meetup.deleted_mark}" name="meetupFormMap.deleted_mark" id="deleted_mark">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="请输入备注"
                           name="meetupFormMap.remark" id="remark">
                </div>
            </div>
        </div>
