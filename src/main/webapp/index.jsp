        ...
        <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
            ...
            <li class="dropdown"><a href="index.html#"
                ...
                <ul class="dropdown-menu animated fadeInRight">
                    ...
                    <c:if test="${userFormMap.accountName!='visitor'}">
                        <li><a href="#" onclick="javascript:updatePasswordLayer();">密码修改</a></li>
                    </c:if>
                    <li class="divider"></li>

                    <!-- 传用户账号的用意是可以用它来区分数据集权限等，TODO -->
                    <li><a nav-n="常用功能,信息星云,${ctx}/common/${userFormMap.accountName}/infoNav.shtml"
                           href="javascript:void(0);">信息星云</a></li>
                    ...
                    <li>
                        <a href="index.shtml">
                            <span class="badge bg-danger pull-right">0</span> 我的任务
                        </a>
                    </li>
                                    ...
                                    <c:forEach var="key" items="${list}" varStatus="s">
                                        ...
                                        <li <c:if test="${s.index==0}">class="active"</c:if>>
                                            <a
                                                ...
                                                <c:if test="${s.index==4}">
                                                    <i class="fa fa-search icon"> <b class="bg-success"></b>
                                                    </i>
                                                </c:if>
                                                <c:if test="${s.index==5}">
                                                    <i class="fa fa-tasks icon"> <b class="bg-danger"></b>
                                                    </i>
                                                </c:if>
                                                <c:if test="${s.index==6}">
                                                    <i class="fa fa-th-list icon"> <b class="bg-warning"></b>
                                                    </i>
                                                </c:if>
                                                <c:if test="${s.index==7}">
                                                ...
                                                <c:if test="${s.index==8}">
                                                    <i class="fa fa-share-square-o icon"> <b class="bg-info"></b>
                                                    </i>
                                                </c:if>
                                                <c:if test="${s.index==9}">
